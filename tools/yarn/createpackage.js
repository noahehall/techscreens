// https://github.com/jsxtools/frontend/blob/master/cmd/create.js
...
## Installation
\`\`\`sh
npm install @techscreens/${name}
\`\`\`
## Usage
\`\`\`js
import ${fnName} from '@techscreens/${name}';
${fnName}();
\`\`\`
[frontend]: https://github.com/techscreens/frontend
`;
